...
## Quality gates
- **Combined macro Jaccard:** `0.8655` (gate: ≥ 0.8) → ✅ PASS
- **Per-branch ≥ 0.7:** → ✅ PASS
  - `free_text_heterogeneous` (n=35): `0.8078` ✅
...
|---|---|---|---|---|---|
| `free_text_heterogeneous` | 35 | `0.8078` | `0.8406` | `0.8106` | `0.6000` |
...
| Metric | Value |
|---|---|
| jaccard_macro | `0.8655` |
| micro_precision | `0.8242` |
| micro_recall | `0.9259` |
| micro_f1 | `0.8721` |
| macro_precision | `0.8115` |
| macro_recall | `0.9218` |
| macro_f1 | `0.8561` |
| hamming_loss | `0.0183` |
...
- Cache creation tokens: **2,850** (paid at 1.25× price)
- Cache-hit rate on input: **17.0%**
- **Estimated total cost:** $2.5308
...
| `so_about_me_rep_100_1k_b` | `free_text_heterogeneous` | [URL, PERSON_NAME, ADDRESS] | [PERSON_NAME, URL, AGE] | [ADDRESS] | [AGE] | `0.500` |
...
| `hn_comments_2019` | `free_text_heterogeneous` | [PERSON_NAME, PHONE, URL] | [URL, PERSON_NAME] | [PHONE] | [] | `0.667` |
...
entities — decoding is handled by downstream specialized engines.
```
