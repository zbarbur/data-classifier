"""Validate S3-B proposed patterns against the S2 11K WildChat corpus."""
...
log = logging.getLogger("s3b_validate")

SPIKE_DIR = Path(__file__).parent.parent.parent / "s2_spike"
CORPUS = SPIKE_DIR / "corpus.jsonl"
PROPOSALS = Path(__file__).parent / "s3b_proposed_patterns.json"
OUT = Path(__file__).parent / "s3b_corpus_validation.json"
