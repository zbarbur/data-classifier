...
def generate_report(sprint: int, samples_per_type: int = 500) -> str:
    ...
    col_data, col_text = _capture_column_report(corpus)
    ...
    w(f"| **F1** | **{overall_f1:.3f}** | **{col_f1:.3f}** |")
...
if __name__ == "__main__":
    ...
    report = generate_report(sprint=args.sprint, samples_per_type=args.samples)
